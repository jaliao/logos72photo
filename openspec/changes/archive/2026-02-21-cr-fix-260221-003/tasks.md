...
- [x] 5.2 `git push origin main` 觸發 Cloudflare Pages 重新部署
- [x] 5.3 正式環境確認：點選時段後相簿列表正常顯示（不再發生 Worker exception）
- [x] 5.4 正式環境確認：相簿列表顯示 8 個 1 小時格子
- [x] 5.5 正式環境確認：點擊有照片的 1 小時格子，照片正常顯示
- [x] 5.6 正式環境確認：首頁日期選擇器文字為黑色
