...
> AI 工作上下文文件 — 依 `.ai-rules.md` 自動產生，版本 v0.1.58
...
- **v0.1.58**（本次）— cr-spec-260322-002：響應式背景圖；`GalleryBackground` 改依 viewport 寬度切換背景（手機 `bg-mb-1.png` / 桌機 `bg-pc-1.png`），使用 CSS `@media (min-width: 640px)`
