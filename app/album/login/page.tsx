        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-zinc-300 bg-white/80 px-3 py-2 font-mono text-sm outline-none focus:border-zinc-500 focus:ring-1 focus:ring-zinc-500"
              required
            />
          </div>
